import{b9 as p,ba as e,da as F,db as G,bz as H,bb as C,by as B,d as E,dc as N,ai as n,dd as K,de as W,bc as Z,bd as L,df as q,a as M,bN as j,bf as J,bZ as Q}from"./index-rsfv-EN3.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
